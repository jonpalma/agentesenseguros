<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $name = strip_tags(trim($_POST["cotiza-name"]));
		$name = str_replace(array("\r","\n"),array(" "," "),$name);
        $seguro = trim($_POST["seguro"]);
        $tel = trim($_POST["cotiza-tel"]);
        $email = filter_var(trim($_POST["cotiza-email"]), FILTER_SANITIZE_EMAIL);
        $message = trim($_POST["cotiza-mssg"]);
        ...
        $recipient = "geraldinthpalacios@agentesenseguros.com.mx, vicentebaca@agentesenseguros.com.mx";

         // Set the email subject.
        $subject = "Solicitud de cotización de $name";

        // Build the email content.
        $email_content = "Mensaje enviado desde la forma de cotizacion de Agentes/Consultores en Seguros\n";
        $email_content .= "Nombre: $name <$email>\n";
        $email_content .= "Seguro: $seguro\n";
